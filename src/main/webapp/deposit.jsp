...
<tr >
    ...
    <div class="a2" style="border-right:#666666 1px dotted;" ><h1><center>DEPOSIT DETAILS</h1></center>
			<br>
...
request.setAttribute("list",list);
		...
		if(status==true){
			...
			PreparedStatement ps=con1.prepareStatement("Select * from newaccount where accountno=?");
			...
			System.out.println("da"+dataamount);
			
			}
			Connection con2=dao.getConnection();
			System.out.println("ps1");
			PreparedStatement ps1=con2.prepareStatement("update newaccount set amount=? where accountno=? ");
			...
			status1 = ps1.executeUpdate();
		     ...
		     <table border="1" width="100%">  
		    	<tr><th>Account No</th><th>User Name</th><th>Amount</th></tr>  
		    	<tr><td><%out.print(accountno); %></td><td><%out.print(username); %></td>
		    	 <td><% out.print(dataamount); %></td></tr>
