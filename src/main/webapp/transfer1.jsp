...
<tr >
    ...
    <td width="450" valign="top">
    	<div class="a1" style="border-right:#666666 1px dotted;"><h1><center>TRANSFER FORM</h1></center><br>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
				<form action="transfer.jsp" >
					...
					<tr><td>TARGET ACCOUNT NO:</td><td><input type="number" name="taccountno" required/></td></tr>
